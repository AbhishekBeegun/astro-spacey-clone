...
const Details = ({link,h1,h2,h3,p,background}) => {
  return (
    <div class="px-5 pt-24 lg:px-44 lg:pt-24">
        <div class="h-full text-white">
            <a href="/" class="flex items-center gap-1 text-sm p-4 uppercase"> 
            &#60; Back To Launches
           </a>
            ...
            class="bg-cover h-[25vh] lg:h-[70vh] flex justify-center items-center">
            ...
            <div class="py-10 flex flex-col gap-2">
                <h2 class="text-lg text-[#808080] ">{h2}</h2>
                <h1 class="text-3xl">{h1}</h1>
            </div>

            <div class="flex flex-col lg:flex-row gap-4 pb-10">
                <h3 class="lg:w-[50%] leading-6">{h3}</h3>
                <p class="lg:w-[50%] leading-6">{p}</p>
            </div>
        </div>
    </div>
  )
